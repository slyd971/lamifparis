...
components/
  ...
  Contact.tsx       09 — Contact (fond framboise + marquee jaune) — inclut le footer du site
...
Identité visuelle : fond **noir** (`charbon`) majoritaire, en alternance avec des sections **framboise** ; le vermillon reste réservé au Hero, le jaune aux accents (kickers, chiffres, hovers).
